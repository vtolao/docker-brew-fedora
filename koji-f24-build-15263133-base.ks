...
url --url="http://kojipkgs.fedoraproject.org/pub/alt/releases/24/Cloud/x86_64/os/"
user --name=none
repo --name="koji-override-0" --baseurl=http://kojipkgs.fedoraproject.org/pub/alt/releases/24/Cloud/x86_64/os/
